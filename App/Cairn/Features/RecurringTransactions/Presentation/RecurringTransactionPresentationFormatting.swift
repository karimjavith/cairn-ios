//
//  RecurringTransactionPresentationFormatting.swift
//  Cairn
//
...
extension RecurrenceFrequency: CaseIterable {
    static var allCases: [RecurrenceFrequency] {
        [
            .daily,
            .weekly,
            .monthly,
...
enum RecurringTransactionMoneyFormatter {
...
enum RecurringTransactionMoneyTextParser {
...
enum RecurringTransactionDateFormatter {
